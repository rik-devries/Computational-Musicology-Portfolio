...
***
This plot shows the chordogram of *One More Light*. One of the most obvious visible things is the repeating pattern that starts in Ab major, then lowers to Ab7 en drops down to Db major. This is indeed the audible pattern in the song. It starts all the way at the beginning already as the melody then starts, with heavy reverb. 

### Novelty of older albums
```{r, echo = FALSE}
ite_data <-
  get_tidy_audio_analysis("60a0Rd6pjrkxjPbaKzXjfq") %>%
  select(segments) %>%
