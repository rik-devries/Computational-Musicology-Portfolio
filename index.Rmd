...
plot(as.phylo(ddata), type = "fan", tip.color = colors[album],
     label.offset = 0.3, cex = 0.8)
```

***
In this fan-shaped dendrogram we can see how clusters the newer album *One More Light* (shown in blue) compares to the older album *Hybrid Theory* (shown in red). We see that there are a few outliers, but it's easy to spot the heavy cluster forming. Good Goodbye seems to be very similar to the older songs and less to the newer songs. This may be because this is a collaboration song with Stormzy and Pusha T. They add a lot of rapping to the songs, making it more like one of the songs in the older albums. The songs *One More Light* and *Cure for the Itch* seem to be relatively unrelated to any other songs in either album. This is not what I expected, as *One More Light* is a very defining song for the album (which is the reason the album is named after it) and to me songs like *Heavy* and *Halfway Right* sound a lot like it. Another observation I do not have an explanation for would be the two clusters within *Hybrid Theory*, some in the bottom of the graph and some in the top.
